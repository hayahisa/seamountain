...
<div class="row"> <!-- 表示範囲の設定 -->
	...
	<div class="middle col-lg-10 col-md-10 col-xs-12"> <!-- 中央表示 -->
		...
		<br>
			<div class="container">
	    		<h5 class="left-align valign-wrapper"><i class="material-icons medium ">person</i>新規教員登録</h5>
	  		</div>
	        <br>
	        <br>
	        <div class="row container">

	    		<form class="col s12" action="Teacher_registration" method="post">
					<div class="row">
						<label style="color:red"><%=nomsg %></label>
	        			<div class="input-field col s12  ">
	          				<input id="gakuseki" type="text" class="validate" name="number" maxlength="7" required>
	          				<label for="gakuseki">教員番号</label>
	        			</div>
	      			</div>
